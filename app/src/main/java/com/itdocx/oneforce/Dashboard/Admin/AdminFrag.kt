...
import com.itdocx.oneforce.MainActivity
import com.itdocx.oneforce.Models.dataofUser
import com.itdocx.oneforce.R
import com.itdocx.oneforce.databinding.FragmentAdminBinding
...
class AdminFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.rlAdminAnnouncements.setOnClickListener {

            findNavController().navigate(R.id.action_adminFrag_to_updateAnnouncements)
        }
        ...
        binding.rlAdminWithdrawReq.setOnClickListener {
            findNavController().navigate(R.id.action_adminFrag_to_withdrawReqFrag)

        }


        binding.rlAdminParticipants.setOnClickListener {
            findNavController().navigate(R.id.action_adminFrag_to_participantsFrag)
        }


        binding.rlAdmincheckComplains.setOnClickListener {
            findNavController().navigate(R.id.action_adminFrag_to_userComplaints)
        }
