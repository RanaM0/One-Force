...
class RequestAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btnDepFund.setOnClickListener {
            ...
            val depositMoney = holder.etAmount.text.toString().replace(Regex("[^0-9.]"), "") // Suppose depositMoney is "50"
            val currentBalance =
...
// Now you can proceed similarly as before
    ...
    private fun updateUserBalanceData(name: String, email: String, currentBalance: String, id: String) {
                            ...
                            if (balanceData != null) {
                                ...
                                snapshot.ref.setValue(balanceData)
                                    .addOnSuccessListener {
                                        ...
                                        Toast.makeText(context, "Funds Deposited Successfully", Toast.LENGTH_SHORT).show()
                                    }
                    ...
                    for (snapshot in dataSnapshot.children) {
                        ...
                        snapshot.ref.removeValue()
                            ...
                            .addOnFailureListener { e ->
                                ...
                                Toast.makeText(context, "Failed to remove deposit request: ${e.message}", Toast.LENGTH_SHORT).show()
                            }
                    }
                } else {
                    // Handle case where the deposit request doesn't exist
                    Toast.makeText(context, "Deposit request does not exist", Toast.LENGTH_SHORT).show()
                }
            }
